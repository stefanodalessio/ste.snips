...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.0, 32.0, 392.0, 47.0 ],
					"presentation_linecount" : 9,
					"text" : "be sure to have your integrated mic as input and your speakers as out, check the menu: options / audio status to set audio in and out, and remember to switch on the audio again (bottom right of the patch)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 122.0, 105.0, 150.0, 20.0 ],
					"text" : "tap on your computer mic"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 147.0, 190.0, 88.0, 22.0 ],
					"text" : "onepole~ 2000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 115.0, 152.0, 44.0, 22.0 ],
					"text" : "noise~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 21.0, 152.0, 82.0, 22.0 ],
					"text" : "onepole~ 200"
				}
...
,
					"patching_rect" : [ 21.0, 104.0, 90.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 22.0, 382.0, 67.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
,
					"patching_rect" : [ 22.0, 357.0, 98.0, 22.0 ],
					"prototypename" : "ste.snippet",
					"text" : "p ste.autoSave",
					"textcolor" : [ 0.114268571138382, 0.646994113922119, 1.0, 1.0 ],
					"varname" : "autoSave"
...
,
					"patching_rect" : [ 21.0, 270.0, 100.0, 22.0 ],
					"prototypename" : "ste.snippet",
					"text" : "p ste.audioOut~",
					"textcolor" : [ 0.114268571138382, 0.646994113922119, 1.0, 1.0 ],
					"varname" : "audioOut~"
...
, 			{
		...
		"originid" : "pat-691",
		"parameters" : 		{
			"obj-29::obj-14" : [ "lock&close[4]", "lock&close", 0 ],
			"obj-29::obj-29" : [ "loadAudioStatus[1]", "loadAudioStatus", 0 ],
			"obj-29::obj-32" : [ "edit[4]", "edit", 0 ],
...
, 			{
				"name" : "snap00_20250418_3.maxsnap",
...
,
						"fileref" : 						{
							"name" : "snap00",
							"filename" : "snap00_20250418_3.maxsnap",
							"filepath" : "~/Documents/Max 9/Snapshots",
							"filepos" : -1,
							"snapshotfileid" : "56b239440951f64c7d61ace062b32489"
						}
