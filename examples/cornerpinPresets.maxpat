...
,
					"patching_rect" : [ 15.0, 755.0, 366.0, 22.0 ],
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 6.0, 67.0, 317.0, 127.0 ],
													"text" : "reads a float and returns 1 when the value is above ONthreshold or 0 when the value drops below OFFthreshold (ONthreshold minus hysteresis)\n\nsecond output gives a bang when the incoming float reaches the ONthreshold\nthird output gives a bang when the incoming float drops below OFFthreshold (ONthreshold minus hysteresis)\n"
												}
...
,
					"patching_rect" : [ 231.0, 375.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 231.0, 525.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 231.0, 460.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 3.0, 524.0, 208.0 ],
					"text" : "similarly to the clapCompositing example, also here we can clap to interact with some preset\n\nwe have a ste.audioIn~ that gets the mic input, followed by a ste.toFloat~ that measures the incoming sound volume and feeds the measurement as a float number to the ste.threshOnOff,\nwhenever the float raises above the set ONthreshol parameter the ste.threshOnOff outputs a trigger/bang out of the second output (you might need to open the ste.threshOnOff to set a ONthreshold value that fits with the amount of sound volume coming in you mic)\nthe resulting bang triggers a counter that counts up, a ste.slide smoothes the number changes creating a softer transition, a modulo [%] wraps the increasing value around 4. and a [+ 1] gives us a continuous ramp that starts from 1, ends at 5 and wraps again.\nthis ramp value is fed into the ste.3dCornerpin.\nin max 9 we can transition between presets and this gives us the possibility to easily create soft transitions between states, in this case we are moving the corner pin around, over a countdown video background\n"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 278.0, 551.0, 187.0, 64.0 ],
					"text" : "math magic to seamlessly transition from preset 4 to 1 \n(making a copy of preset 1 in to slot 5)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 266.0, 325.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 231.0, 252.0, 150.0, 20.0 ],
					"text" : "check your mic in and clap"
				}
...
,
					"patching_rect" : [ 231.0, 345.0, 87.0, 22.0 ],
					"prototypename" : "ste.snippet",
					"text" : "p ste.toFloat~",
					"textcolor" : [ 0.114268571138382, 0.646994113922119, 1.0, 1.0 ],
					"varname" : "toFloat~"
...
,
					"patching_rect" : [ 231.0, 289.0, 90.0, 22.0 ],
					"prototypename" : "ste.snippet",
					"text" : "p ste.audioIn~",
					"textcolor" : [ 0.114268571138382, 0.646994113922119, 1.0, 1.0 ],
					"varname" : "audioIn~"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 231.0, 583.0, 36.0, 22.0 ],
					"text" : "+ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 231.0, 556.0, 33.0, 22.0 ],
					"text" : "% 4."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 231.0, 635.0, 50.0, 22.0 ]
				}
...
,
					"patching_rect" : [ 231.0, 491.0, 67.0, 22.0 ],
					"prototypename" : "ste.snippet",
					"text" : "p ste.slide",
					"textcolor" : [ 0.114268571138382, 0.646994113922119, 1.0, 1.0 ],
					"varname" : "slide"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 231.0, 667.0, 89.0, 22.0 ],
					"text" : "prepend preset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 231.0, 423.0, 61.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 280.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 396.0, 316.0, 69.0, 22.0 ],
					"text" : "metro 2000"
				}
...
,
					...
					"output_texture" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 5.0, 548.0, 150.0, 30.0 ],
					"saved_attribute_attributes" : 					{
						"candicane2" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 5.0, 215.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
,
					...
					"output_texture" : 0,
					"parameter_enable" : 0,
					"patching_rect" : [ 29.0, 252.0, 150.0, 30.0 ],
					"saved_attribute_attributes" : 					{
						"candicane2" : 						{
							"expression" : ""
						}
...
, 							{
								"box" : 								{
									...
									"restore" : 									{
										...
										"live.text" : [ 0.0 ],
										"lock&close" : [ 0.0 ],
										"lower_left_X" : [ 0.502914845943451 ],
										"lower_left_Y" : [ 0.920840740203857 ],
										"lower_right_X" : [ 0.696929752826691 ],
										"lower_right_Y" : [ 0.782690525054932 ],
										"upper_left_X" : [ 0.502900958061218 ],
										"upper_left_Y" : [ 0.507109999656677 ],
										"upper_right_X" : [ 0.764269113540649 ],
										"upper_right_Y" : [ 0.506987392902374 ],
										"white" : [ 0 ]
									}
,
									"text" : "autopattr",
...
,
					"patching_rect" : [ 29.0, 308.0, 111.0, 22.0 ],
					"prototypename" : "ste.snippet",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 74.0, 659.0, 80.0, 49.0 ]
				}
...
,
					"patching_rect" : [ 5.0, 630.0, 88.0, 22.0 ],
					"prototypename" : "ste.snippet",
					"text" : "p ste.3dWorld",
					"textcolor" : [ 0.114268571138382, 0.646994113922119, 1.0, 1.0 ],
					"varname" : "3dWorld"
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 18.0, 877.0, 67.0, 22.0 ],
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
,
					"patching_rect" : [ 18.0, 852.0, 98.0, 22.0 ],
					"prototypename" : "ste.snippet",
					"text" : "p ste.autoSave",
					"textcolor" : [ 0.114268571138382, 0.646994113922119, 1.0, 1.0 ],
					"varname" : "autoSave"
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 405.5, 410.12109375, 240.5, 410.12109375 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-29::obj-14" : [ "lock&close[8]", "lock&close", 0 ],
			"obj-29::obj-29" : [ "loadAudioStatus", "loadAudioStatus", 0 ],
			"obj-29::obj-32" : [ "edit[8]", "edit", 0 ],
...
,
						"fileref" : 						{
							...
							"filepos" : -1,
							"snapshotfileid" : "2958c33e4915432349228a54f63d0d1d"
						}
